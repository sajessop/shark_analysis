...
if(Event.Mes.data.dump=='Abbey_Sarah') 
{
  ...
  #1.1. gillnet
  setwd('C:/Users/S.Jesso/OneDrive - Department of Primary Industries And Regional Development/Final_EMobs/Outputs12-01-23.2/Gillnet')
  filenames=list.files(pattern='*.csv')
  dummy.GN <- lapply(filenames, read.csv,skip=4)
  
  #1.2. longline
  setwd('C:/Users/S.Jesso/OneDrive - Department of Primary Industries And Regional Development/Final_EMobs/Outputs12-01-23.2/Longline')
  filenames=list.files(pattern='*.csv')
...
checklist.net.maxn
#lensubset <- len %>% filter(Taxa != "Kyphosus sydneyanus")
```
```{r}
checklist.net.maxn.2 <- Video.net.interaction %>% filter(Species%in%c("aequabilis", "tenuicaudatus"))
checklist.net.maxn.2
```
