...
```{r}
  setwd(
    'C:/Users/S.Jesso/OneDrive - Department of Primary Industries And Regional Development/Final_EMobs/Deck/OutputDeck2/20-01-23'
  )
dummy.d2 <- list()  
 ...
 for (i in 1:length(dummy.d2))
  {
    ...
    separate("Curtin opcode", c("Region", "DPIRD code", "Position"), sep="_", remove=FALSE) %>% 
      dplyr::select(all_of(deck.2.fish))
